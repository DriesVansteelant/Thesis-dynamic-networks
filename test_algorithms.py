...
class AlgorithmsTestCase(unittest.TestCase):
    ...
    def test_ping_pong(self):
        g = dn.DynGraph()
        g.add_interaction("A", "B", 0)
        g.add_interaction("B", "C", 1)
        g.add_interaction("A", "C", 2)
        g.add_interaction("D", "E", 0)
        g.add_interaction("C", "E", 3)
        g.add_interaction("A", "E", 4)
...
altest = AlgorithmsTestCase()
altest.test_all_time_respecting_paths()
altest.test_annotated_paths()
altest.test_DAG()
altest.test_ping_pong()
altest.test_time_respecting_paths()